...
return new class extends Migration
{
    ...
    {
        Schema::create('palmvein_logs', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('device_id')->nullable(false);
            $table->string('device_zone', 100)->nullable(false);
            ...
            $table->text('palm_capture')->nullable(true);
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('palmvein_logs');
    }
};
